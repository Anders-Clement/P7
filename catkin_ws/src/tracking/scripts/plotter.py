    ...
    for i, dataSet in enumerate(dataSets):
        ...
        for j, startStopIndex in enumerate(startStopTimeIndeces):
            ...
            if j == 0 and startStopIndex[0] == 0:
                offset = time_log_filter[startStopIndex[0]] - time_log_spot[startStopTimeIndecesSpot[0][0]]
        ...
        for j, startStopIndexSpot in enumerate(startStopTimeIndecesSpot):
            ...
            for l in range(lastStopIndex, len(time_log_spot)):
                time_log_spot[l] -= sumToSubtract

            lastStopTime = time_log_spot[startStopIndexSpot[1]]
            lastStopIndex = startStopIndexSpot[1]
        ...
        # # subtract starttime to start at time 0
        # startTime = new_time_log_filter[0]
        # for j in range(len(new_time_log_filter)):
        #     new_time_log_filter[j] -= startTime
        # startTime = new_time_log_spot[0]
        # for j in range(len(new_time_log_spot)):
        #     new_time_log_spot[j] -= startTime
